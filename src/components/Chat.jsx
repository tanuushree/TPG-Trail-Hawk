...
function Chat({originSmartAccount}) {  
    console.log(originSmartAccount)
    const navigate = useNavigate()
    const location = useLocation()
    // const [stateAddress,setStateAddress] = useState((location.state.smartAccountAddress || null))
    ...
    async function login() {
       try {
            ...
            // provider = new ethers.providers.Web3Provider( window.ethereum);
                signer = originSmartAccount.getsigner();
                console.log(signer , CONTRACT_ADDRESS, contractABI)
    ...
    useEffect( () => {
        // console.log("hello")
        // if(!location.state.smartAccountAddress == null){
        //     alert("There seems to be an issue, please login again");
        //     navigate("/login")
        // }        
        loadFriends();
            ...
            <Row>
                ...
                <Col style={{ "paddingRight":"0px", "borderRight":"2px solid #000000" }}>
                    <div style={{ "backgroundColor":"#DCDCDC", "height":"100%", overflowY:"auto" }}>
                          ...
                          { chats }
                          <AddNewChat myContract={ myContract } addHandler={addChat} />
                    </div>
                </Col>
